                        ...
                        class App(customtkinter.CTk):
                            def __init__(self):
                                ...
                                self.TitleLabel = customtkinter.CTkLabel(
                                    self, text="Medical Inventory System", text_color="White",
                                    font=("Arial", 24, "bold")
                                )
                                ...
                                self.AddItemLabel = customtkinter.CTkLabel(self.AddItemFrame, text="Add New Item",
                                                                           font=("Arial", 18))
                                self.AddItemLabel.grid(row=0, column=0, columnspan=2, pady=10)

                                self.AddNameBox = customtkinter.CTkEntry(self.AddItemFrame,
                                                                         placeholder_text="Enter Item Name", width=300)
                                self.AddNameBox.grid(row=1, column=0, columnspan=2, padx=10, pady=5)

                                self.AddAmountBox = customtkinter.CTkEntry(self.AddItemFrame,
                                                                           placeholder_text="Enter Amount", width=300)
                                self.AddAmountBox.grid(row=2, column=0, columnspan=2, padx=10, pady=5)

                                # Expiration Date Entry Box
                                self.AddExpiry = customtkinter.CTkEntry(self.AddItemFrame,
                                                                        placeholder_text="Enter Expiration Date: MM/DD/YYYY",
                                                                        width=300)
                                ...
                                self.EditItemLabel = customtkinter.CTkLabel(self.EditFrame, text="Edit Existing Item",
                                                                            font=("Arial", 18))
                                ...
                                # Change Name
                                self.EditSelectedName = customtkinter.CTkEntry(self.EditFrame,
                                ...
                                # Change Amount
                                self.EditSelectedAmount = customtkinter.CTkEntry(self.EditFrame,
                                                                                 placeholder_text="Enter New Amount",
                                                                                 width=300)
                            ...
                            def addstuff(self):
                                ...
                                if name and amount:
                                    ...
                                    try:
                                        ...
                                        self.write_to_log("Add",
                                                          f"Added item '{name}' with ID {new_id}, amount {amount}" +
                            ...
                            def update_name_amount(self):
                                ...
                                if selected_item and update_fields:
                                    try:
                                        ...
                                        updated_fields_list = ", ".join(
                                            [f"{key}: {value}" for key, value in update_fields.items()])
                                        self.write_to_log("Update",
                                                          f"Updated item '{original_name}' to {updated_fields_list}.")
                            ...
                            def monitor_changes(self):
                                ...
                                try:
                                    with collection.watch(pipeline=change_pipeline,
